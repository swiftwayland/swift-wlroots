...
public final class WLRPointer: WLRInputDeviceProtocol, RawPointerInitializable {
    public final class MotionEvent: RawPointerInitializable {
    ...
    public final class AbsoluteMotionEvent: RawPointerInitializable {
    ...
    public final class ButtonEvent: RawPointerInitializable {
    ...
    public final class AxisEvent: RawPointerInitializable {
